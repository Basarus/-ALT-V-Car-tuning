...
var jsc = {
	...
	getPickerDims : function (thisObj) {
		var w = 2 * thisObj.controlBorderWidth + thisObj.width - 20;
	...
	pub : function (targetElement, opts) {
		...
		function drawPicker () {
			...
			p.box.style.background = 'rgba(0,0,0,0.8)';
